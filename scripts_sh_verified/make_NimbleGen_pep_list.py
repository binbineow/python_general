        ...
        if len(line0) > 127:
            if not '(' in line0[23]:
                if 'HLA-DRB1' in line0[127] and not '/' in line0 [127]:
                    ...
                    #print line0[127]
                    if line0[127] == hla0:
                        list0=[line0[23],'IEDB',line0[1],line0[109],line0[101],line0[111],line0[102],str(len(line0[23])),discover_core(line0[23])]
...
for hla0 in target_mhc:
    ...
    file0.write('Sequence,Data source,ID or unshuffled sequence,Qualitative Measurement,Assay type,Quantitative measurement,Measurement unit,Peptide length,Predicted binding core,Note\n')
