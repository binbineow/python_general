...
for hla0 in target_mhc:
    ...
    file0.write('Sequence,Type,ID or unshuffled sequence,Qualitative Measurement,Assay type,Quantitative measurement,Measurement unit,Peptide length,Predicted binding core,Note\n')
