...
def get_mhc_seq(dict_mcl,pid_list,con_seq_list,list_var,dict_h,dict_l):
    ...
    for pid0 in pid_list:
        mhc2_frag = dict_mcl[pid0]['MHC1_frag']
        mhc2_gene = dict_mcl[pid0]['MHC1_gene']
...
list_files = ['MCL_all_nonIg_mhc1.list','MCL_all_nonIG_gene_mhc1.list','MCL_all_V_heavy_mhc1.list','MCL_all_V_light_mhc1.list','MCL_all_IG_constant_mhc1.list']
...
pickle.dump(dict_mcl,open(path0+'MCL_data11_18_2015_10_9_2016_mhc1_v1.1.dict','w+'))
