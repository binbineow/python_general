##this version enables changing figures

def plot_2_lines(y_pred,y_reco,name0,chain0,
                 label1='MARIA Predicted', label2='MHCII peptide Recovered',
                 path0='/home/stanford/rbaltman/users/bchen45/data/MCL_data/ig_specific/variable_region_plots/'):
    import numpy as np
