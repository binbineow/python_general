...
import random
from plot_predictedv2_1 import *
...
file_name0 = 'MCL_data11_18_2015_10_9_2016v1.1.dictwith_netmhcii'
...
def predict_with_netmhc_stored(dict_netmhc,seq_frag):
    ...
    for seq0 in seq_frag:
        if seq0 in dict_netmhc:
            val_pos_1.append(dict_netmhc[seq0])
        else:
    ...
    val_pos_1 = moving_max(val_pos_1)
    if is_filter_glyc:
        val_pos_1 = filter_glyc(seq_frag,val_pos_1)
    return val_pos_1
...
def main(file_name_pid,file_name0,file_out,chain0):
    ...
    for pid0 in pid_list:
        ...
        model_rnn = dict_mcl[pid0]['NetMCHIIpan_dict'] #the dictionary file not rnn here
