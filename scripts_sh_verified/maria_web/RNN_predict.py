...
path_encoding = '/Users/binbineow2/Documents/Machine_Learning/HLA_prediction/maria_website/model/'
mhc_dict_file = 'DRB1_pseudo_seq.dict'
#path where the model is saved
path_model = '/Users/binbineow2/Documents/Machine_Learning/HLA_prediction/maria_website/model/'
...
#better predict with higher efficiency 
def import_model(path_model, model_name0,weight_name0):
    model_name0 = path_model+ model_name0
    weight_name0 = path_model + weight_name0
    model0 = model_from_json(open(model_name0).read())
...
#model0 = import_model(path_model,model_mel1,weight_mel1)

def predict_with_rnn(model0,list_pos_1,dict0,max_l):
    list_pos_1 = encoding_data(list_pos_1, max_l,dict0)
    val_pos_1 = model0.predict_proba(list_pos_1,batch_size=b_size,verbose=0)[:,1]
    class_pos_1 = model0.predict_classes(list_pos_1,batch_size=b_size,verbose=0)
    return val_pos_1,class_pos_1


def predict_and_get_stats(list0, cut_off=0.4, path0 = path_model,model0=model_name0,weight0=weight_name0,dict0=dict_aa,max_l=max0):
