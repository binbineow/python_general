...
def make_training(path_save,hla_name0,list_len,cluster_list,positive_list,negative_list,version0,t_ratio,v_ratio):
    ...
    file_out = open(path_save+hla_name0+version0+'_tr_'+str(t_ratio)+'.fasta','w+')
    train_list = []
    val_list = []
...
for hla_name0, list0 in dict_hla_pep.iteritems():
    ...
    make_training(path_save,hla_name0,len(list0),cluster_list,IEDB_p,IEDB_n,version0,t_ratio,v_ratio)
