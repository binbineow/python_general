...
file_store = 'mcl_patient_mhc2.training_list1'
...
[train_pos0,train_pos1,val_pos0,val_pos1,train_neg,val_neg,list_random,list_ms_random,list_shuffle_random,
 list_anti_patient_train,list_anti_patient_val] = pickle.load(open(path_store+file_store,'r'))
...
for i in range(0,n_iteration):
    ...
    x_train = [[],[]]
    x_train[0] = list(x_pos_cycle[0]) + list(x_train_neg[0])
    x_train[1] = list(x_pos_cycle[1]) + list(x_train_neg[1])
    print(len(x_train[0]))
    #fitting
