...
model1 = 'rnn_combine_train_modelv2.2_d0.2_n128.json'
...
print(weight_list[-1])
#to save records
weight_name = 'rnn_combine_train_modelv1.weight2.2_d0.2_batch256_n128'
record_file = path_save + 'record_trainingv2_d0.2_batch256_n128.txt'
#parameters
n_iteration = 100
nb0 = 1
vb0 = 0
