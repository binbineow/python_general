...
weight_list = make_w_list([100000,500000,100000],[x_train_pos[0],x_train_neg[0],x_train_iedb[0]])
#weight_list = make_w_list([80000,100000],[x_train_pos[0],x_train_neg[0]])
print(weight_list[0])
print(weight_list[-1])
#to save records
weight_name = 'rnn_wopretrain_weightv5_d0.45.h5.1_5_1'
record_file = path_save + 'record_trainingv5_d0.45.1_5_1.txt'
#parameters
n_iteration = 100
nb0 = 1
vb0 = 1
