...
def predict_with_rnn(model0,list_pos_1):
    ...
    class_pos_1 = model0.predict(list_pos_1,batch_size=b_size)
...
def RNN_predict(list0, cut_off=0.4, path0 = path_model,model0=path_model+model_name0,weight0=path_model+weight_name0):
